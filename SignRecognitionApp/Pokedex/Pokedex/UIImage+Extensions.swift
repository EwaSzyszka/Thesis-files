...
extension UIImage {
    ...
    /// THE IMMAGE THAT THE MODEL NEEDS AS INPUT IS  299X299
    /// HERE YOU ARE RESCALING THE IMAGES TO THE CORRECT SIZE
    ...
    ///MLMODEL FORMAT TAKES CVPixelBuffer AS INPUT
    ///SO THE UIImage NEEDS TO BE CONVERTED
